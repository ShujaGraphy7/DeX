      ...
      <div className="flex justify-center">
        <div className="relative inline-block mb-2">
          <button
            onClick={() => toggle()}
            type="button"
            className="text-2xl font-bold text-fuchsia-600 sm:text-sm hover:animate-spin"
          >
            <FiSettings />
          </button>
          {popup ? (
                ...
                <div className="flex mx-3 justify-between items-center">
                  ...
                  <div className="relative">
                    <input
                      ...
                      max="1.5"
                      defaultValue="0.5"
                      className="w-full p-3 text-sm rounded-r-full text-fuchsia-900 border border-fuchsia-300  bg-fuchsia-50 focus:ring-fuchsia-500 focus:border-fuchsia-500 dark:bg-fuchsia-700 dark:border-fuchsia-600 dark:placeholder-fuchsia-400 dark:text-white dark:focus:ring-fuchsia-500 dark:focus:border-fuchsia-500"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex mx-3 justify-between items-center">
                <div className="relative">
                  <input
                    ...
                    max="45"
                    defaultValue="30"
                    className="w-full p-3 rounded-full text-sm text-fuchsia-900 border border-fuchsia-300  bg-fuchsia-50 focus:ring-fuchsia-500 focus:border-fuchsia-500 dark:bg-fuchsia-700 dark:border-fuchsia-600 dark:placeholder-fuchsia-400 dark:text-white dark:focus:ring-fuchsia-500 dark:focus:border-fuchsia-500"
                  />
                </div>
                <div>
